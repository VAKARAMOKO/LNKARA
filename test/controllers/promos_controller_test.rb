...
class PromosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create promo" do
    assert_difference('Promo.count') do
      post promos_url, params: { promo: { code_school: @promo.code_school, slug: @promo.slug, title: @promo.title, user_id: @promo.user_id } }
    end
  ...
  test "should update promo" do
    patch promo_url(@promo), params: { promo: { code_school: @promo.code_school, slug: @promo.slug, title: @promo.title, user_id: @promo.user_id } }
