...
/* This is the custom StimulusReflex controller for StudentInvoiceReflex.
...
export default class extends ApplicationController {
   ...
   * Example:
   *
   *   <a href="#" data-reflex="StudentInvoiceReflex#example">Example</a>
   *
   * Arguments:
   *
   ...
   *
   *   reflex - the name of the reflex e.g. "StudentInvoiceReflex#example"
   *
